...
pub(super) struct EfiTimeRaw {
    ...
    get_wakeup_time:
        extern "efiapi" fn(*mut bool, *mut bool, *mut EfiTimeRepresentation) -> EfiStatus,
...
impl EfiTimeRaw {
    ...
    pub(super) fn set_wakeup_time(
        ...
        (self.set_wakeup_time)(enabled, time).into_enum()
    }
}

...
impl EfiIPv4DevicePath {
    ...
    pub fn local_port(&self) -> u16 {
        unsafe { (self.local_port.as_ptr() as *const u16).read_unaligned() }
    }

    pub fn remote_port(&self) -> u16 {
        unsafe { (self.remote_port.as_ptr() as *const u16).read_unaligned() }
    }
...
impl EfiDevicePathRepr for EfiIPv4DevicePath {}

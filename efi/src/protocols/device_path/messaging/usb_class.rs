...
impl EfiUsbClassDevicePath {
    pub fn vendor_id(&self) -> u16 {
        unsafe { (self.vendor_id.as_ptr() as *const u16).read_unaligned() }
    }

    pub fn product_id(&self) -> u16 {
        unsafe { (self.product_id.as_ptr() as *const u16).read_unaligned() }
    }
...
impl EfiDevicePathRepr for EfiUsbClassDevicePath {}

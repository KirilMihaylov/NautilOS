...
impl EfiSerialAttachedScsiExDevicePath {
    ...
    pub fn device_and_topology_info(
        &self,
    ) -> EfiSerialAttachedScsiExDevicePathDeviceAndTopologyInfo {
        unsafe {
            (self.sas_address.as_ptr()
                as *const EfiSerialAttachedScsiExDevicePathDeviceAndTopologyInfo)
                .read_unaligned()
        }
    }
...
impl EfiDevicePathRepr for EfiSerialAttachedScsiExDevicePath {}
...
impl EfiSerialAttachedScsiExDevicePathDeviceAndTopologyInfo {
    fn additional_info_bytes(
        &self,
    ) -> Result<EfiSerialAttachedScsiExDevicePathAdditionalInfoBytes, u16> {

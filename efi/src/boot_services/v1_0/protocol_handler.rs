...
use crate::protocols::{device_path::EfiDevicePathProcotol, EfiProtocol};
...
pub(super) struct EfiProtocolHandlerRaw {
    ...
    locate_device_path: extern "efiapi" fn(
        *const EfiGuid,
        *mut *const EfiDevicePathProcotol,
        *mut EfiHandle,
    ) -> EfiStatus,
...
impl EfiProtocolHandlerRaw {
    #[inline(always)]
    pub(super) fn install_protocol_interface(
        &self,
    ...
    #[inline(always)]
    pub(super) fn reinstall_protocol_interface(
        &self,
        handle: &mut EfiHandle,
        protocol_guid: &EfiGuid,
    ...
    #[inline(always)]
    pub(super) fn uninstall_protocol_interface(
        &self,
        handle: &mut EfiHandle,
        protocol_guid: &EfiGuid,
        interface: Option<&[u8]>,
    ...
    #[inline(always)]
    pub(super) fn register_protocol_notify(
        &self,
        protocol_guid: &EfiGuid,
        event: EfiEvent,
    ...
    #[inline(always)]
    pub(super) fn locate_device_path(
        &self,
        protocol_guid: &EfiGuid,
        mut device_path: &mut EfiDevicePathProcotol,
    ...
    #[inline(always)]
    pub(super) fn install_configuration_table(
        &self,
        table_guid: &EfiGuid,
        table_data: VoidPtr,
    ) -> EfiStatusEnum {
